...
export const RackView = ({
  ...
  const handleContactUs = () => {
    window.open('mailto:info@t76.org?subject=Dr.%20PD%20feedback', '_self')
  }
  ...
  const messageLogMenuItems = useMemo<MenuItem[]>(
    () => [
      ...
      },
      {
        ...
        label: isMessageLogMarking ? 'Adding marker...' : 'Add marker at present time',
        meta: 'M',
      ...
      },
      {
        ...
        label: 'Add marker at current location',
        disabled:
          !activeDriver ||
          isMessageLogMarking ||
          selectedLogRow === null ||
