...
export const MAX_TIMESTRIP_ZOOM_DENOMINATOR = 400_000_000
 ...
 * @returns Integer denominator from 500 to 400,000,000.
 */
 ...
 * @returns Compact zoom label, e.g. `500ns`, `1µs`, `1ms`, or `400ms`.
 */
