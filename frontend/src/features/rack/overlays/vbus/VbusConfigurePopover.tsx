...
import styles from '../../instruments/DrpdVbusInstrumentView.module.css'
  ...
  <div className={styles.headerPopup}>
    ...
    <div className={styles.headerPopupRow}>
      <div className={styles.headerPopupField}>
        <label className={styles.headerPopupLabel} htmlFor={`${instrumentId}-ovp`}>
          OVP (V)
        </label>
        <input
          id={`${instrumentId}-ovp`}
      ...
      <div className={styles.headerPopupField}>
        <label className={styles.headerPopupLabel} htmlFor={`${instrumentId}-ocp`}>
          OCP (A)
        </label>
        <input
          id={`${instrumentId}-ocp`}
    ...
    <p className={styles.headerPopupHint}>
      OVP range: 0-{VBUS_OVP_MAX_V}V · OCP range: 0-{VBUS_OCP_MAX_A}A
    </p>
    <div className={styles.headerPopupField}>
      <label className={styles.headerPopupLabel} htmlFor={`${instrumentId}-display-rate`}>
        Display Rate (Hz)
      </label>
      <input
    ...
    <p className={styles.headerPopupHint}>
      Display update rate range: {VBUS_MIN_DISPLAY_UPDATE_RATE_HZ}-{VBUS_MAX_DISPLAY_UPDATE_RATE_HZ} Hz
    </p>
    {configureError ? (
